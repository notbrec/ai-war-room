      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 20px 60px' }}>
        ...
        <div style={{ paddingTop: 40, paddingBottom: 4 }}>
          ...
          <p style={{ marginTop: 10, fontSize: 17, lineHeight: 1.55, color: LABEL, letterSpacing: '-0.02em', maxWidth: 460 }}>
            {filtered.length} models ranked. Contamination-free, objective ground-truth answers — no LLM judge.
          </p>
        ...
        <div style={{ marginTop: 44, display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))' }}>
          {[
            { label: 'Tasks',         value: '23 tasks · 7 categories',  sub: 'Reasoning, math, coding, data, and more.' },
            { label: 'Judging',       value: 'Objective ground-truth',    sub: 'No LLM judge. Verifiable answers only.'   },
            { label: 'Refresh cycle', value: 'Every 6 months',           sub: 'Questions rotate to limit contamination.' },
            { label: 'Bias filter',   value: 'High unseen available',     sub: 'Sharper signal, less memorized behavior.' },
          ].map(item => (
        ...
        <div style={{ marginTop: 40, textAlign: 'center' }}>
          <p style={{ fontSize: 13, color: 'rgba(60,60,67,0.38)', letterSpacing: '-0.01em' }}>
            Based on LiveBench · Spotlight Paper ICLR 2025 · {RELEASE}
          </p>
        </div>
      </div>
    </div>
