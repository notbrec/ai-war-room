// ─── AI-WAR · Model Data ──────────────────────────────────────────────────
// Source: LiveBench-2026-01-08  |  livebench.ai
// Columns: global, reasoning, coding, agenticCoding, math, dataAnalysis, language, if
// To auto-update: replace DATA_URL with your API endpoint or hosted JSON file.
// The component fetches this URL every AUTO_REFRESH_MS milliseconds.

export const DATA_URL = null; // e.g. 'https://yourapi.com/livebench.json'
export const AUTO_REFRESH_MS = 30 * 60 * 1000; // 30 minutes
export const RELEASE = 'LiveBench-2026-01-08';

export const ORG_CONFIG = {
  'OpenAI':      { color: '#10A37F', bg: '#E8F8F2' },
  'Google':      { color: '#4285F4', bg: '#E8F0FE' },
  'Anthropic':   { color: '#CC785C', bg: '#FBF0EC' },
  'DeepSeek':    { color: '#5856D6', bg: '#EEEEFE' },
  'xAI':         { color: '#1C1C1E', bg: '#EBEBEB' },
  'Alibaba':     { color: '#FF6B00', bg: '#FFF0E6' },
  'Mistral':     { color: '#FF3B30', bg: '#FFF0EF' },
  'Moonshot AI': { color: '#00C7BE', bg: '#E6FAFB' },
  'Minimax':     { color: '#8B5CF6', bg: '#F3EFFE' },
  'Xiaomi':      { color: '#FF6900', bg: '#FFF3E6' },
  'Z.AI':        { color: '#007AFF', bg: '#E7F3FF' },
  'Arcee':       { color: '#34C759', bg: '#EDFAF2' },
  'NVIDIA':      { color: '#76B900', bg: '#F0F7E6' },
};

// [name, org, global, reasoning, coding, agenticCoding, math, dataAnalysis, language, if]
const RAW = [
  ['GPT-5.4 Thinking xHigh Effort',           'OpenAI',      80.28, 88.12, 77.54, 70.00, 94.15, 79.31, 82.63, 70.22],
  ['Gemini 3.1 Pro Preview High',              'Google',      79.93, 84.00, 76.45, 65.00, 91.04, 78.54, 85.38, 79.10],
  ...
  ['Claude 4.6 Sonnet Thinking Med Effort',    'Anthropic',   75.47, 84.77, 79.27, 60.00, 86.99, 77.95, 76.10, 63.22],
  ...
  ['Qwen 3.6 Plus',                            'Alibaba',     70.85, 75.83, 78.18, 55.00, 83.72, 69.91, 74.99, 58.34],
  ['GPT-5 Pro',                                'OpenAI',      70.48, 81.69, 72.11, 51.67, 86.17, 57.04, 80.69, 63.96],
  ['GLM 5.1',                                  'Z.AI',        70.18, 72.52, 75.37, 55.00, 84.89, 63.23, 71.78, 68.45],
  ['GPT-5.4 Nano xHigh',                       'OpenAI',      70.13, 81.05, 72.14, 49.12, 91.27, 67.64, 62.47, 67.20],
  ...
  ['Grok 4.20 Beta',                           'xAI',         67.96, 75.28, 66.09, 43.33, 87.06, 62.86, 77.72, 63.39],
  ['GPT-5.4 Mini xHigh',                       'OpenAI',      67.54, 72.50, 71.62, 47.46, 78.56, 70.95, 71.46, 60.27],
  ['GPT-5 Mini High',                          'OpenAI',      65.91, 68.32, 68.20, 46.67, 82.20, 55.20, 75.52, 65.27],
  ['Minimax M2.7',                             'Minimax',     63.49, 74.79, 54.90, 50.00, 80.54, 56.34, 66.78, 61.12],
  ...
  ['Gemini 3.1 Flash Lite Preview High',       'Google',      61.68, 59.66, 68.52, 33.33, 73.56, 54.90, 73.18, 68.62],
  ['Gemma 4 31B',                              'Google',      61.62, 59.42, 60.33, 40.00, 73.94, 58.76, 71.34, 67.58],
  ...
  ['GPT-5.3 Instant',                          'OpenAI',      59.99, 63.12, 78.63, 28.33, 72.41, 48.02, 70.00, 59.40],
  ...
  ['MiMo V2 Pro',                              'Xiaomi',      58.14, 69.70, 68.85, 30.00, 76.96, 49.21, 69.07, 43.22],
  ...
  ['Gemini 2.5 Flash Max Thinking Sep',        'Google',      53.09, 51.45, 67.50, 23.33, 75.35, 60.98, 65.34, 27.68],
  ['Qwen 3 235B Thinking 2507',                'Alibaba',     52.97, 59.40, 68.97,  6.67, 73.39, 52.18, 69.52, 40.64],
  ...
  ['Qwen 3 Next 80B Thinking',                 'Alibaba',     50.41, 58.16, 60.66,  8.33, 74.26, 53.58, 56.31, 41.54],
  ['DeepSeek V3.2 Exp',                        'DeepSeek',    49.85, 45.50, 73.19, 36.67, 64.38, 44.26, 65.60, 19.33],
  ['GLM 5V Turbo',                             'Z.AI',        49.62, 56.11, 73.90,  3.33, 70.41, 54.13, 62.28, 27.20],
  ['GPT-5.2 No Thinking',                      'OpenAI',      48.91, 42.80, 76.45, 40.00, 58.25, 47.68, 49.97, 27.20],
  ['Qwen 3 235B Instruct 2507',                'Alibaba',     48.84, 58.43, 69.61, 13.33, 68.03, 44.72, 66.07, 21.72],
  ['GPT-5 Nano High',                          'OpenAI',      48.62, 40.29, 62.39, 23.33, 68.41, 43.41, 46.84, 55.70],
  ['Qwen 3 Next 80B Instruct',                 'Alibaba',     48.35, 54.75, 68.20, 10.00, 70.18, 49.78, 66.34, 19.19],
  ['Kimi K2 Instruct',                         'Moonshot AI', 48.10, 42.23, 74.28, 31.67, 58.15, 43.34, 66.69, 20.36],
  ['Gemini 2.5 Flash Max Thinking Jun',        'Google',      47.74, 44.64, 66.03, 16.67, 68.75, 47.31, 62.27, 28.50],
  ...
  ['Gemini 2.5 Flash Lite Max Jun',            'Google',      42.56, 43.34, 66.41,  5.00, 61.04, 47.04, 51.98, 23.08],
  ['Gemini 2.5 Flash Lite Max Sep',            'Google',      42.39, 36.16, 65.39,  1.67, 64.90, 47.88, 52.60, 28.11],
  ...
  ['Grok 4.20 Beta Non-Reasoning',             'xAI',         39.70, 25.63, 58.54, 38.33, 45.52, 43.48, 42.04, 24.35],
  ['Qwen 3 30B',                               'Alibaba',     39.01, 36.68, 48.88,  1.67, 65.35, 44.92, 54.47, 21.11],
  ...
  ['Nemotron 3 Super 120B',                    'NVIDIA',      32.51, 34.39, 54.07, 23.00, 36.43, 21.23, 30.04, 28.41],
];

export const MODELS = RAW.map(([name, org, global, reasoning, coding, agenticCoding, math, dataAnalysis, language, ifScore], i) => ({
  rank: i + 1,
  name,
  org,
  global,
  ...
  initials: name.replace(/[^A-Za-z0-9 ]/g, '').trim().split(/\s+/).slice(0, 2).map(w => w[0].toUpperCase()).join(''),
}));
