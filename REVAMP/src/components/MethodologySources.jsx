...
const SOURCE_DETAIL = {
  ...
  aa:         { how: 'Official Data API, only when an API key is configured server-side (ARTIFICIAL_ANALYSIS_API_KEY). Nothing is scraped; without a key the affected columns show N/A.', gives: 'Intelligence / Coding / Agentic / Math indexes, individual benchmark scores, output speed, time to first token, end-to-end time, media generation times, TTS / STT / speech-to-speech evaluations.' },
