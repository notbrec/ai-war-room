...
function scoreColor(v) {
  if (v >= 75) return '#5E9E70';
  if (v >= 60) return '#5C81B8';
  if (v >= 45) return '#C89150';
  return '#CD5C4E';
}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <button
              ...
              style={{
                ...
                color: '#5C81B8', fontSize: 13, fontWeight: 600,
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 20px 60px' }}>
        ...
        <div style={{ paddingTop: 40, paddingBottom: 4 }}>
          ...
          <div style={{ marginTop: 6, display: 'flex', alignItems: 'center', gap: 6 }}>
            <div style={{ width: 7, height: 7, borderRadius: 4, background: '#5E9E70' }} />
          ...
          {CATEGORIES.map(cat => (
            <button
              ...
              style={{
                ...
                background: category === cat.key ? '#5C81B8' : 'rgba(116,116,128,0.12)',
