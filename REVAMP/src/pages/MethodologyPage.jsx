...
const PRINCIPLES = [
  { num: 1, accent: '#CD5C4E', title: 'Arena battles',        body: 'Each model matchup is a real conversation shown to human voters. They pick the better response. No automated judging — only human preference.' },
  ...
  { num: 3, accent: '#5C81B8', title: 'Confidence intervals', body: 'The ±CI value shows rating uncertainty. A model with ±7 is precisely ranked. A model with ±23 needs more battles before its position stabilises.' },
  { num: 4, accent: '#5E9E70', title: 'Open-weight models',   body: 'MIT, Apache 2.0 and similar licences are tagged "Open". These models can be run locally or fine-tuned — a key distinction for real-world deployment.' },
  { num: 5, accent: '#C89150', title: 'Live pricing',          body: 'Pricing is synced from OpenRouter every 30 minutes. Cost per 1M input and output tokens — the real numbers developers actually pay.' },
];

const ELO_TIERS = [
  { range: '≥ 1500',    label: 'S-Tier', color: '#5E9E70', desc: 'Elite. State-of-the-art performance across most tasks.' },
  { range: '1400–1499', label: 'A-Tier', color: '#5C81B8', desc: 'Excellent. Competes with the best, strong across the board.' },
  { range: '1300–1399', label: 'B-Tier', color: '#C89150', desc: 'Good. Solid performers, competitive in specific domains.' },
  { range: '< 1300',    label: 'C-Tier', color: '#CD5C4E', desc: 'Developing. Useful for simpler or cost-sensitive tasks.' },
];
