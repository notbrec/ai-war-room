...
function eloColor(v) {
  ...
  if (v >= 1450) return '#5C81B8';
  if (v >= 1420) return '#C89150';
  return '#CD5C4E';
}
function eloTier(v) {
  if (v >= 1490) return 'S';
    ...
    <div className="page-enter" style={{ background: 'transparent', fontFamily: SF, minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: mobile ? '40px 16px 96px' : '64px 24px 112px' }}>
        ...
        <header style={{ marginBottom: mobile ? 28 : 36 }}>
          ...
          <div style={{
            display: 'flex', alignItems: 'center', gap: mobile ? 12 : 18,
            margin: '10px 0 18px',
        ...
        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 8, alignItems: 'center' }}>
          ...
          <Pill active={filterOpen}     color="#5E9E70" label="Open"     icon="🔓" onClick={() => setFilterOpen(v => !v)} />
          ...
          {activeFilters > 0 && (
            <button onClick={clearFilters}
              ...
              style={{
                height: 28, paddingInline: 12, borderRadius: 980,
                background: 'rgba(255,59,48,0.10)', color: '#CD5C4E',
              ...
              {filtered.slice(0, 5).map((m, fi) => {
                ...
                return (
                  ...
                  <article style={{
                    ...
                    {/* Lab logo */}
                    <div style={{
                      width: 40, height: 40, background: iconBg,
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      flexShrink: 0,
                    }}><LabLogo org={m.org} size={22} /></div>
                  ...
                  >
                    ...
                    <div style={{ padding: '10px 0 10px 10px', minWidth: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 2 }}>
                        ...
                        {model.isOpen    && <span style={{ fontSize: 9, color: '#5E9E70', background: 'rgba(52,199,89,0.12)',    borderRadius: 3, padding: '1px 4px', flexShrink: 0 }}>🔓</span>}
                      </div>
              ...
              <RowReveal key={model.slug} index={i}>
                ...
                >
                  ...
                  <div style={{ padding: '10px 8px', display: 'flex', gap: 4, alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    {model.isOpen && (
                      <span style={{ fontSize: 9, fontWeight: 700, color: '#5E9E70', background: 'rgba(52,199,89,0.12)', borderRadius: 4, padding: '2px 5px', letterSpacing: '0.04em', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>
                        Open
                      </span>
                    )}
                  </div>
                ...
                {expanded && (
                  <div style={{
                    ...
                    <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                      ...
                      {model.isOpen && <span style={{ fontSize: 10, fontWeight: 600, color: '#5E9E70', background: 'rgba(52,199,89,0.12)', borderRadius: 6, padding: '3px 8px', letterSpacing: '-0.005em', fontFamily: MONO }}>Open weight</span>}
                    </div>
                  </div>
                )}
